...
<div class="container">
    <div class="row align-items-center justify-content-center" style="margin-top: 10%">
        <div class="col-md-7">
            <div class="card w-75">
                <div class="card-body">
                    <h5 class="card-title">Auto aanmaken</h5>
                    <form action="createAutoInDatabase.php" method="post" style="margin-bottom: 1rem">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="kmstand" placeholder="Km stand" name="kmstand" required>
                        </div>
                        <div class="form-group">
